...
// import { AlertTriangle, BarChart3, Download, Microscope, Ruler } from "lucide-react";
...
//   { key: "avg_lpips", label: "LPIPS", decimals: 4 },
//   { key: "avg_l1", label: "L1", decimals: 4 },
//   { key: "avg_direction", label: "Direction", decimals: 4 },
//   { key: "avg_edge_strength", label: "Edge Strength", decimals: 4 },
...
//   { key: "direction", label: "Direction", decimals: 4 },
//   { key: "edge_strength", label: "Edge Strength", decimals: 4 },
//   { key: "histogram", label: "Histogram", decimals: 4 },
// ];
...
//           <Microscope size={32} className="text-gray-400" aria-hidden="true" />
...
//           alt={`Restored output from ${display_name}`}
...
//       {hasGroundTruth && per_upload_metrics && !per_upload_metrics.error && (
//         <div>
...
//               vs. your ground truth, masked region
//             </span>
//           </div>
...
//             Official benchmark results are based on 305 test images and are not
//             computed from the uploaded image.
//           </p>
//         </div>
//       )}
      ...
      {hasGroundTruth && per_upload_metrics && !per_upload_metrics.error && (
        <div>
          <div className="text-[10px] text-[var(--color-success)] uppercase tracking-wider mb-2 flex items-center gap-1.5 font-semibold">
            ...
            Per-Upload Metrics
            <span className="ml-auto text-gray-500 normal-case tracking-normal font-normal">
              vs. your ground truth | brushstroke metrics use masked region
            </span>
          </div>
